...
links[1] = "http://yangshi.localhost.com/index.php?m=poster&c=index&a=poster_click&siteid=1&id=12";
if (isIE){
...
links[2] = "http://yangshi.localhost.com/index.php?m=poster&c=index&a=poster_click&siteid=1&id=11";
if (isIE){
	if (document.readyState=="complete"){
		statAD('1', '11', '11');
	} else {
...
imgs[1].src = "http://yangshi.localhost.com/uploadfile/2017/1116/20171116035251612.jpg";
imgs[2].src = "http://yangshi.localhost.com/uploadfile/2017/1116/20171116033520964.jpg";
var tits = new Array();
tits[1] ="";
tits[2] ="";
var imgwidth = 1200;//图片宽度
var imgheight = 800;//图片宽度
var str = "";
...
function statAD(siteid, id, pid) {
	...
	sp.src = "http://yangshi.localhost.com/index.php?m=poster&c=index&a=show&siteid="+siteid+"&id="+id+"&spaceid="+pid;
