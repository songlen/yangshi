<?php defined('IN_PHPCMS') or exit('No permission resources.'); ?>
	<div class="footer">
		<div class="container footer_content">
			...
			<div class="saoma">
				<ul>
					<li><img src="<?php echo APP_PATH;?>statics/default/images/foot_03.jpg" alt=""><p>Official Wechat</p></li>
					<li><img src="<?php echo APP_PATH;?>statics/default/images/foot_03.jpg" alt=""><p>Official Weibo</p></li>
				</ul>
			</div>
			<div class="foot_fenxiang">
				<p class="fen_wenzi">Share:</p>
				<ul>
					<li class="share-qq"><img src="<?php echo APP_PATH;?>statics/default/images/foot_08.jpg" alt=""><p>QQ</p></li>
					<li><img src="<?php echo APP_PATH;?>statics/default/images/foot_10.jpg" alt=""><p>WeChat</p></li>
					<li class="share_weibo"><img src="<?php echo APP_PATH;?>statics/default/images/foot_12.jpg" alt=""><p>blog</p></li>
				</ul>
			</div>
		</div>
		<div class="web_brief">
			<p><!-- <span class="banquan">版权所有</span>： --><?php echo $SEO['copyright'];?> <span class="beian">ICP：<?php echo $SEO['beian'];?></span></p>
		</div>
	</div>
